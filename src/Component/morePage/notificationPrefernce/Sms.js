...
const Sms = () => {
  return (
    <div>
      <h1 className="text-lg font-medium ml-9 mt-4">SMS</h1>
      <p className="text-sm text-[#878787] ml-9 mb-2">Get instant messages on your Flipkart registered phone number</p>
      <Component>
        <Box>
          <LeftComponent>
            <div className="flex">
